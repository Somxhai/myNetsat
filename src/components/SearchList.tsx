...
const FacultySearchList = ({ value }: type) => {
  ...
  return (
    <button onClick={handleChange} className="text-left w-full border-b-2 flex justify-between items-center bg-gray-50">
      <div>
      ...
      <input
        ...
        className="bg-gray-200 focus:ring-white rounded focus:ring-0 border-gray-100"
      />
    </button>
  );
};

export default FacultySearchList;
